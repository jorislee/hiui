...
qemu-system-aarch64 -m 1024 -smp 2 -cpu host -M virt,highmem=off \
    ...
    -append root=/dev/vda \
    -device virtio-net,netdev=net0 -netdev user,id=net0,net=192.168.1.0/24,hostfwd=tcp:127.0.0.1:1122-192.168.1.254:22,hostfwd=tcp:127.0.0.1:2333-192.168.1.254:80 \
